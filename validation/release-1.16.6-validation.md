...
- `scripts/package_plugin.py 1.16.6`: PASS. 6개 스킬, 34개 파일, 링크·버전·CRC·바이트 일치와 SHA-256을 확인했다. ZIP SHA-256은 `a3a0acadbbe908dbfd7cb8ec6ab115b2d82795a95fc456de0e926773cc4342f0`이며 `.sha256` 기록과 일치한다. [패키지 기록](package-1.16.6.json)
- 원본 `quick_validate.py`·`validate_plugin.py`: PASS.
- `validation/package-check-1.16.6` 압축 해제본 `quick_validate.py`·`validate_plugin.py`: PASS.
