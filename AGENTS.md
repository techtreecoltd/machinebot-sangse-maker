...
- 사용자가 분기를 지정했다면 전체 메뉴 선택을 다시 강요하지 않는다. 납품 종류와 표현 방식을 구분하고, 메인 썸네일 한 장도 모델·장점·스튜디오·정보성 카피의 적합성을 판단한다. 최초 안내는 공통 start-here.md, 썸네일 판단은 thumbnail-design.md를 따른다.
