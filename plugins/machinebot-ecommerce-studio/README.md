...
**버전 1.18.0** — 시작 질의응답으로 필요한 제작 타입을 추천하고, 선택한 범위와 제품 자료를 기존 제작 절차에 연결합니다. 누끼를 흰색 스튜디오 제품 마스터컷으로 정의하고, 확인 가능한 여러 각도·전문 조명·접지 그림자를 직접 생성·검수합니다. 사진으로 보이지 않는 제품 가치는 CG 판단 카탈로그로 연출·효용·상세 흐름에 연결합니다.
